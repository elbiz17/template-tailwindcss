    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <h3
              className={`mb-4 ml-4 ${sidebarExpanded ? "text-sm " : "text-xs"} font-semibold text-bodydark2`}
            >
              MENU
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        {(sidebarExpanded || isMobile) && (
                          <div
                            // className={`${sidebarExpanded || isMobile ? "block" : "hidden"}`}
                          >
                            Dashboard
                            <svg
              ...
              <li>
                ...
                >
                  ...
                  {(sidebarExpanded || isMobile) && "Calendar"}
                </Link>
              </li>
              {/* <!-- Menu Item Calendar --> */}
              ...
              <li>
                ...
                >
                  ...
                  {(sidebarExpanded || isMobile) && "Profile"}
                </Link>
              </li>
              {/* <!-- Menu Item Profile --> */}
              ...
              <li>
                ...
                >
                  ...
                  {(sidebarExpanded || isMobile) && "Tables"}
                </Link>
              </li>
              {/* <!-- Menu Item Tables --> */}
              ...
              <li>
                ...
                >
                  ...
                  {(sidebarExpanded || isMobile) && "Settings"}
                </Link>
              </li>
              {/* <!-- Menu Item Settings --> */}
            </ul>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  ...
                  {(sidebarExpanded || isMobile) && "Chart"}
                </Link>
              </li>
              {/* <!-- Menu Item Chart --> */}
